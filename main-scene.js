window.BalanceBall = window.classes.BalanceBall =
    class BalanceBall extends Scene_Component {
        constructor(context, control_box)     // The scene begins by requesting the camera, shapes, and materials it will need.
        {
            ...
            this.materials =
                {
                    ...
                    alumni: context.get_instance(Fake_Bump_Map).material(
                        Color.of(0.15,0.15,0.15,1),
                        {
                            ambient: 1.0,
                            diffusivity: 0.5,
                            texture: context.get_instance("assets/alumni.jpg", false)
                        }
                    ),
                };
            ...
            this.chosen_material = this.materials.ice;
        }
        ...
        switch_material(val) {
            if (val === "ICE") {
                ...
                this.chosen_material = this.materials.ucla;
            }
            else if (val === "ALUMNI") {
                this.chosen_material = this.materials.alumni;
            }
        }
        ...
        display(graphics_state){
            ...
            let chosen = skin.options[skin.selectedIndex].value;
            this.switch_material(chosen);
            ...
            this.shapes.square.draw(graphics_state, this.floor_transform, this.chosen_material);
